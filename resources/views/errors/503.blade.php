...
<body class="bg-gray-50 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="max-w-md w-full flex flex-col items-center justify-center gap-8 text-center">
        ...
        <div class="flex flex-col items-center">
            ...
            <h1 class="text-8xl md:text-9xl font-black text-blue-600 mb-2 tracking-tighter drop-shadow-sm">503</h1>

            <!-- Subtitle -->
            <p class="text-xl md:text-2xl font-extrabold text-gray-800 mb-8 uppercase tracking-wide">Service Unavailable
            </p>
